...
class AboutVariableScope < Neo::Koan
  ...
  #class variable is at the class level, every object of class can modify it, and others objects of class will have the new value, kind of like only one exists
  # ------------------------------------------------------
