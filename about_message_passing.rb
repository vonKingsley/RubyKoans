...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Send could be overwritten method, so __send__ will always offer the correct behavior
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # We could potentially handle NoMethodErrors or dynamically create methods on the fly
    # NOTE:
    #
